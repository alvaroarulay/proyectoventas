    ...
    export default {
        ...
        methods : {
            ...
            validarPersona(){
                ...
                if (!this.num_documento) this.errorMostrarMsjPersona.push("No ingreso un numero de Documento.");
                if (!this.contacto) this.errorMostrarMsjPersona.push("El nombre de Contacto no puede estar vacío.");
                if (!this.telefono_contacto) this.errorMostrarMsjPersona.push("El Teléfono de Contacto no puede estar vacío.");
