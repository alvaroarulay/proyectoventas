...
class UserController extends Controller
{
    ...
    public function selectUser(){
        $user = User::join('personas','users.id','=','personas.id')->select('users.usuario as usuario', 'personas.nombre as nombre','personas.tipo_documento as documento','personas.num_documento as num_doc','personas.direccion as direccion','personas.telefono as telefono','personas.email as email')->where('users.id','=',\Auth::user()->id)->first();
        return $user;
    }
