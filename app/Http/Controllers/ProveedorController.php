...
use App\Proveedor;
use App\Persona;
use App\Http\Requests\ProvedorStoreRequest;
use App\Http\Requests\ProvedorUpdateRequest;
...
class ProveedorController extends Controller
{
    ...
    public function store(ProvedorStoreRequest $request)
    {
        if (!$request->ajax()) return redirect('/');
    ...
    public function update(ProvedorUpdateRequest $request)
    {
        if (!$request->ajax()) return redirect('/');
